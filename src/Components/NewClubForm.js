...
const NewClubForm = () => {
  ...
  const demoWarning = (
    <div className="warning">
      <p>
        Not available on demo. Full version at{" "}
        <a href="https://github.com/JoaquinAkerman/crud-clubs-2/tree/local-deploy">
          https://github.com/JoaquinAkerman/crud-clubs-2/tree/local-deploy
        </a>
      </p>
    </div>
  );
